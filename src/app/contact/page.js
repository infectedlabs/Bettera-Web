...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-white font-cabinet">
      ...
      <div className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-gray-700 mb-6">
                  We'd love to hear from you. Whether you have questions about Bettera, need support, or want to share your feedback, we're here to help.
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">Available 24/7 in app</div>
                    </div>
                  </div>
                </div>
              </section>
          ...
          <div className="mt-16 text-center">
            ...
            <a 
              href="/#faq" 
              className="inline-block bg-[#d4ff00] text-black px-6 py-3 rounded-full font-medium hover:bg-[#c4ef00] transition-all duration-300 hover:scale-105"
            >
              View FAQ
            </a>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-[#d4ff00] py-16 px-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <img 
                  ...
                  className="w-8 h-8 rounded-lg"
                />
                <span className="font-bold text-black text-xl">Bettera</span>
              </div>
              <p className="text-black text-sm">
                AI nutrition app that creates personalized meal plans based on your blood report and health conditions.
              </p>
            </div>
            
            <div className="space-y-4">
              <h3 className="font-bold text-black">Product</h3>
              {["How It Works", "FAQ"].map((link, index) => (
                <a 
                  key={index}
